...
public class FuncionarioGUI extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Funcão");

        comboFuncao.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecione", "Funcionário", "Instrutor" }));
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        try{
            ...
            Funcionario funcionario = new Funcionario(txtNome.getText(), txtCPF.getText(), getRG(), getGenero(), contato, endereco, getFuncao(), data);
            FuncionarioBO.salvarFuncionario(funcionario);
            limparCampos();
            JOptionPane.showMessageDialog(this, "Funcionário salvo com sucesso.", title, JOptionPane.INFORMATION_MESSAGE);
        } catch (ParseException ex) {} catch (ArgumentoInvalidoException | SelecioneItemException ex) {
