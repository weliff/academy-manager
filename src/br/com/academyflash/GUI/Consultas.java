...
public class Consultas extends javax.swing.JInternalFrame {
    public Consultas(AbstractTableModel tabela) {
    ...
    private void tbConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbConsultaMouseClicked
        System.out.println(tbConsulta.getSelectedRow());
    }//GEN-LAST:event_tbConsultaMouseClicked
    
    private void inicializaTabela(AbstractTableModel tabela){
        tbConsulta.setModel(tabela);
//        tbConsulta.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
//            @Override
